...
export default function Footer() {
  ...
  return (
    <footer id="footer" className="bg-background text-foreground py-16 md:py-24 relative overflow-hidden border-t border-border">
      {/* Decorative Glow */}
      ...
      <div className="container relative z-10 px-8 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-16 lg:gap-24 mb-16">
          ...
          <div className="space-y-10 max-w-sm">
            ...
            <div className="flex gap-4">
              {[
                { id: 'FB', icon: <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c4.56-.93 8-4.96 8-9.75z" /> },
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 pt-6 border-t border-border">
